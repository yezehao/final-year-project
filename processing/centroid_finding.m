...
% save('C:\Users\30348\Documents\final-year-project\data\centroid_v1\2.5_1_1.mat','structure')
% % Save the structure into processing file for further process
% save('centroid_v1\2.5_1_1.mat','structure')

%% Image Processing Version 2
for i = 1:(nframes-1)
    % Image Processing
    [labelpic,num] = ImageProcessing(videoobj,i);    
    % Region Centroid
    prop = regionprops(labelpic,"Centroid"); % get the centroid coordinates
    m = size(prop);
    centroid = zeros(m(1),2);
...
%% Save the structure into data file
save('C:\Users\30348\OneDrive\桌面\final-year-project\data\centroid_v2\2.5_1_1.mat','structure')
% Save the structure into processing file for further process
save('centroid_v2\2.5_1_1.mat','structure')